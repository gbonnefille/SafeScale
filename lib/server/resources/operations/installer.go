...
type Installer interface {
	Check(context.Context, resources.Feature, resources.Targetable, data.Map, resources.FeatureSettings, bool) (resources.Results, fail.Error) // checks if a Feature is installed
